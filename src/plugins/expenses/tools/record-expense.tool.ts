...
export function createRecordExpenseTool(expenseRepo: ExpenseRepository) {
  return tool({
    description:
    ...
    inputSchema: z.object({
      vendor: z.string().describe("Nombre del proveedor o establecimiento (ej: 'Repsol', 'El Corte Inglés')"),
